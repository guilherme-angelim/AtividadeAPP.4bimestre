...
namespace atividade.APP_4bimestre
{
    public partial class frmex3 : Form
    {
        ...
        private void btncalcularwhile_Click(object sender, EventArgs e)
        {
            ...
            while (i <= qtd)
            {
                string compStr = Interaction.InputBox($"Digite o comprimento do cômodo em metros {i}:");
                string largStr = Interaction.InputBox($"Digite a largura do cômodo em metros {i}:");
                /*Mensagem de texto para o usuário, tipo modal*/

                comprimento = Convert.ToDouble(compStr);
                largura = Convert.ToDouble(largStr);
                /*conversão das variáveis recebidas nos inputs*/
        ...
        private void txtareaqtd_TextChanged(object sender, EventArgs e)
        {
